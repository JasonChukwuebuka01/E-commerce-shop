...
// direct to home page
    ...
    return (
        <div className='modalCard'>
            ...
            <button type="button" class="btn btn-primary py-2" onClick={handleShow}>Proceed to Checkout</button>
                    ...
                    <div className="modal-content">
                        <div className="modal-body">
                            <div className="tabs mt-3">
                                    ...
                                    >
                                        ...
                                        <div className="mt-4 mx-4">
                                            ...
                                            <div className="form-mt-3">
                                                ...
                                                <div className="inputbox">
                                                    <input type="number" name="number" min="1" max="999" id="number" className='form-control' required />
                                ...
                                {/* Payment Disclaimer*/}
                                <p className='mt-3 px-4 p-Disclaimer'><em>Payment Disclaimer:In</em> no event shall payment or partial payment by Owners for any materials or service</p>
